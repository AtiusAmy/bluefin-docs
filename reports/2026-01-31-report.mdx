...
| | |
|--------|-------|
| **Total Items** | 145 (36 planned, 109 opportunistic) |
| **Automation** | 60.3% (220 bot PRs out of 365 total PRs) |
| **Contributors** | 22 total, 10 new |
...
- **goose-linux** - Open source, extensible AI agent that goes beyond code suggestions ([#188](https://github.com/ublue-os/homebrew-tap/pull/188), Jan 2)
- **antigravity-linux** - AI Coding Agent IDE ([#199](https://github.com/ublue-os/homebrew-tap/pull/199), Jan 12)
- **linux-mcp-server** - MCP server for Linux system administration and diagnostics ([#221](https://github.com/ublue-os/homebrew-tap/pull/221), Jan 26)
...
**Automation Percentage:** 60.3% (220 bot PRs out of 365 total PRs)

| Repository | Bot PRs | % of Total |
|------------|---------|------------|
| bluefin | 71 | 19.5% |
| bluefin-lts | 55 | 15.1% |
| documentation | 10 | 2.7% |
| iso | 7 | 1.9% |
| common | 1 | 0.3% |
| dakota | 1 | 0.3% |
